    ...
    >
      ...
      <div className="absolute left-0 top-0 bottom-0 w-1/3 pointer-events-none">
        ...
        >
          ...
          />
          <motion.circle
            cx="200" cy="80" r="3" fill="rgba(255,255,255,0.2)"
            initial={{ opacity: 0 }}
            animate={inView ? { opacity: 1 } : {}}
            transition={{ duration: 0.3, delay: 1.5 }}
          />
          <motion.circle
            cx="280" cy="200" r="3" fill="rgba(255,255,255,0.15)"
            initial={{ opacity: 0 }}
            animate={inView ? { opacity: 1 } : {}}
            transition={{ duration: 0.3, delay: 1.7 }}
          />
          <motion.circle
            cx="160" cy="320" r="3" fill="rgba(255,255,255,0.18)"
            initial={{ opacity: 0 }}
            animate={inView ? { opacity: 1 } : {}}
      ...
      <div className="absolute right-0 top-0 bottom-0 w-1/3 pointer-events-none">
        ...
        >
          ...
          />
          <motion.circle
            cx="200" cy="120" r="3" fill="rgba(255,255,255,0.2)"
            initial={{ opacity: 0 }}
            animate={inView ? { opacity: 1 } : {}}
            transition={{ duration: 0.3, delay: 1.6 }}
          />
          <motion.circle
            cx="120" cy="240" r="3" fill="rgba(255,255,255,0.15)"
            initial={{ opacity: 0 }}
            animate={inView ? { opacity: 1 } : {}}
            transition={{ duration: 0.3, delay: 1.8 }}
          />
          <motion.circle
            cx="240" cy="360" r="3" fill="rgba(255,255,255,0.18)"
            initial={{ opacity: 0 }}
            animate={inView ? { opacity: 1 } : {}}
      ...
      <div className="relative z-10 mx-auto max-w-[1320px] px-6 lg:px-10 py-24 md:py-32 text-center">
        <motion.h2
          ...
          className="text-[clamp(1.8rem,4vw,3rem)] font-light leading-[1.15] tracking-tight text-white max-w-2xl mx-auto"
        >

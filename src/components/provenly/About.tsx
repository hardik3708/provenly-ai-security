      ...
      <div className="mx-auto max-w-[1320px] px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-12 items-start">
          ...
          <motion.div
            ...
            className="lg:border-r lg:border-black/[0.06] lg:pr-12"
          >
            {/* Label */}
            ...
            <h2 className="text-[clamp(2rem,4vw,3rem)] font-light leading-[1.12] tracking-tight text-[#121212] max-w-lg">
          ...
          <motion.div
            ...
            className="mt-12 lg:mt-0 flex flex-col items-center lg:items-start"
          >
            <div className="relative w-full max-w-md aspect-square flex items-center justify-center">
              ...
              >
                ...
                >
                  {/* Top face */}
                  <path
                    d="M130 30 L230 80 L130 130 L30 80 Z"
                    fill="#C8442C"
                    fillOpacity="0.9"
                  />
                  {/* Left face */}
                  <path
                    d="M30 80 L130 130 L130 220 L30 170 Z"
                    fill="#E8E9EA"
                  ...
                  {/* Right face */}
                  <path
                    d="M130 130 L230 80 L230 170 L130 220 Z"
                    fill="#D5D6D7"
                    stroke="rgba(0,0,0,0.08)"
                    strokeWidth="0.5"
                  />
